...
# Quantum Dot Properties
    print ("*Quantum Dots")
    radius_qd=1
    #change in band gap (Brus: localisation + confinement + binding)
    delta_e=(1/(2*radius_qd*radius_qd*mass)-1.8/(d1*radius_qd)-binding_o)*(13.605698066*1000)
    print ("Band gap correction " + str(radius_be) + " meV \n")
